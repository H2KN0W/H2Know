...
const Login = () => {
  ...
  const verifyAccess = async (userId) => {
    ...
    if (profileError) {
      ...
      await supabase.auth.signOut();
      throw new Error("Could not check your account profile. Please try again or contact an administrator.");
    }

    if (!profile) {
      await supabase.auth.signOut();
      throw new Error("No H2KNOW profile was found for this Google account. Please ask an administrator to check or approve your account.");
    }
      ...
      <div className="login-page">
        <div className="login-card">
          ...
          <p className="brand-tagline">
            Create a password for email login. You can also continue using Google.
          </p>
